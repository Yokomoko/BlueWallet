...
it('can create escrow address', () => {
  ...
  assert.strictEqual(address, '391ygT71qeF7vbYjxsUZPzH6oDc7QmSWqs');
...
describe.skip('HodlHodl API', function () {
  ...
  it.skip('can get offers', async () => {
    ...
    assert.ok(offers[0]);
    assert.ok(offers[0].asset_code === 'GRS');
  ...
  it.skip('can accept offer', async () => {
    if (process.env.GITHUB_ACTIONS) {
      // dont run here as it always fails
      return;
    }
  ...
  it.skip('can get contract', async () => {
    if (process.env.GITHUB_ACTIONS) {
      // dont run here as it always fails
      return;
    }
  ...
  it.skip('can mark contract as confirmed', async () => {
    if (process.env.GITHUB_ACTIONS) {
      // dont run here as it always fails
      return;
    }
  ...
  it.skip('can get payment methods', async () => {
    if (process.env.GITHUB_ACTIONS) {
      // dont run here as it always fails
      return;
    }
  ...
  it.skip('cat get currencies', async () => {
    if (process.env.GITHUB_ACTIONS) {
      // dont run here as it always fails
      return;
    }
  ...
  it.skip('can create signature for autologin', async () => {
    const Hodl = new HodlHodlApi('');
