...
struct WalletInformationAndMarketWidgetProvider: TimelineProvider {
  ...
  func placeholder(in context: Context) -> WalletInformationAndMarketWidgetEntry {
    return WalletInformationAndMarketWidgetEntry(date: Date(), marketData: MarketData(nextBlock: "1", sats: "100 000 000", price: "$1", rate: 1), allWalletsBalance: WalletData(balance: 1000000, latestTransactionTime: LatestTransaction(isUnconfirmed: false, epochValue: 1568804029000)))
  }
