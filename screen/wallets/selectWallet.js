    ...
    return (
      <SafeBlueArea style={{ flex: 1 }}>
        <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', paddingTop: 20 }}>
          <BlueText style={{ textAlign: 'center' }}>There are currently no Groestlcoin wallets available.</BlueText>
          <BlueSpacing20 />
          <BlueText style={{ textAlign: 'center' }}>
            A Groestlcoin wallet is required to refill Lightning wallets. Please, create or import one.
          </BlueText>
        </View>
      </SafeBlueArea>
    );
