module.exports = {
  ...
  wallets: {
    ...
    list: {
      ...
      tap_here_to_buy: 'Cliquez ici pour acheter du Groestlcoin',
    },
    reorder: {
    ...
    details: {
      ...
      buy_bitcoin: 'Acheter du Groestlcoin',
  ...
  send: {
    ...
    details: {
      ...
      address: 'adresse',
      amount_placeholder: 'montant à envoyer (en GRS)',
      fee_placeholder: 'plus frais de transaction (en GRS)',
  ...
  plausibledeniability: {
    ...
    help:
      ...
      'votre mot de passe. Pour protéger vos biens, Groestlcoin BlueWallet permet de créer un autre ' +
      ...
      "Groestlcoin BlueWallet, débloquera se 'faux' espace de stockage. Le tiers pourra " +
