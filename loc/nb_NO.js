module.exports = {
  ...
  wallets: {
    ...
    import: {
      title: 'importer',
      explanation:
        'Skriv her din mnemonic, private nøkkel, WIF, eller hva som helst annet. GRS BlueWallet vil gjøre sitt beste for å gjette riktig format og importere lommeboken din',
      imported: 'importert',
  ...
  plausibledeniability: {
    ...
    help:
      ...
      'passord. For å holde mynten din trygg, kan GRS BlueWallet opprette en annen' +
      'kryptert lagring, med et annet passord. Under press,' +
      'Du kan oppgi dette passordet til en tredjepart. Hvis inntastet i' +
      'GRS BlueWallet, det vil låse opp ny "falsk" lagring. Dette vil virke' +
