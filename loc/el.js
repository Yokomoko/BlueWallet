module.exports = {
  ...
  wallets: {
    ...
    import: {
      title: 'Εισαγωγή',
      explanation:
        'Γράψε εδώ το μνημονικό (φράση), το ιδιωτικό κλειδί, το WIF, ή ό,τι άλλο έχεις. Το Groestlcoin BlueWallet θα προσπαθήσει να μαντέψει το σωστό format και να εισάγει το πορτοφόλι',
      imported: 'Εισήχθη',
  ...
  plausibledeniability: {
    ...
    help:
      ...
      'κωδικό σας. Για να προστατέψετε τα χρήματά σας, το Groestlcoin BlueWallet μπορεί να δημιουργήσει ένα εναλλακτικό ' +
      ...
      'βάλει στο Groestlcoin BlueWallet θα δει ένα μόνο ένα ψεύτικο αρχείο που μοιάζει ' +
