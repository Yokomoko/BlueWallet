module.exports = {
  ...
  wallets: {
    ...
    options: 'επιλογές',
    createBitcoinWallet:
      'Δεν έχεις πορτοφόλι Groestlcoin. Για να βάλεις χρήματα στο πορτοφόλι Lightning, πρέπει πρώτα να δημιουργήσεις ή να εισάγεις ένα πορτοφόλι Groestlcoin. Θα ήθελες να προχωρήσεις ούτως ή άλλως;',
    list: {
      ...
      tap_here_to_buy: 'Πάτησε εδώ για να αγοράσεις Groestlcoin',
    },
    reorder: {
    ...
    details: {
      ...
      buy_bitcoin: 'Αγόρασε Groestlcoin',
    ...
    import: {
      title: 'Εισαγωγή',
      explanation:
        'Γράψε εδώ το μνημονικό (φράση), το ιδιωτικό κλειδί, το WIF, ή ό,τι άλλο έχεις. Το GRS BlueWallet θα προσπαθήσει να μαντέψει το σωστό format και να εισάγει το πορτοφόλι',
      imported: 'Εισήχθη',
  ...
  send: {
    ...
    details: {
      ...
      address: 'διεύθυνση',
      amount_placeholder: 'ποσό πληρωμής (σε GRS)',
      fee_placeholder: 'συν έξοδα συναλλαγής (σε GRS)',
  ...
  settings: {
    ...
    lightning_settings_explain:
      ...
      ' και βάλτε το URL του εδώ. Αφήστε το κενό για να χρησιμοποιήσετε το LNDHub της GRS BlueWallet (lndhub.groestlcoin.org). Αφού σώσετε τις ρυθμίσεις τυχόν νέα πορτοφόλια που θα δημιουργήσετε θα συνδεθούν στο LNDHub που επιλέξατε.',
  ...
  plausibledeniability: {
    ...
    help:
      ...
      'κωδικό σας. Για να προστατέψετε τα χρήματά σας, το GRS BlueWallet μπορεί να δημιουργήσει ένα εναλλακτικό ' +
      ...
      'βάλει στο GRS BlueWallet θα δει ένα μόνο ένα ψεύτικο αρχείο που μοιάζει ' +
