module.exports = {
  ...
  wallets: {
    ...
    import: {
      title: 'Импорт',
      explanation: 'Напиши тут свою мнемоническую фразу, приватный ключ, WIF - что угодно! GRS BlueWallet постарается угадать верный формат',
  ...
  plausibledeniability: {
    ...
    help:
      ...
      'Чтобы сохранить свой Groestlcoin в безопасности, GRS BlueWallet может создать ' +
      ...
      "GRS BlueWallet, разблокируется 'фальшивое' хранилище. Это будет выглядеть " +
