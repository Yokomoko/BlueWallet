module.exports = {
  ...
  wallets: {
    ...
    import: {
      title: 'Импорт',
      explanation: 'Напиши тут свою мнемоническую фразу, приватный ключ, WIF - что угодно! Groestlcoin BlueWallet постарается угадать верный формат',
  ...
  plausibledeniability: {
    ...
    help:
      ...
      'Чтобы сохранить свой Groestlcoin в безопасности, Groestlcoin BlueWallet может создать ' +
      ...
      "Groestlcoin BlueWallet, разблокируется 'фальшивое' хранилище. Это будет выглядеть " +
