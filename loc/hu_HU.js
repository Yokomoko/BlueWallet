module.exports = {
  ...
  wallets: {
    ...
    list: {
      ...
      tap_here_to_buy: 'Groestlcoin vásárláshoz kattints ide',
    },
    reorder: {
    ...
    details: {
      ...
      buy_bitcoin: 'Groestlcoin vásáslás',
  ...
  send: {
    ...
    details: {
      ...
      address: 'cím',
      amount_placeholder: 'küldendő összeg (GRS)',
      fee_placeholder: 'tranzakciós díj (GRS)',
