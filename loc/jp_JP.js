module.exports = {
  ...
  wallets: {
    ...
    options: 'オプション',
    createBitcoinWallet:
      'Groestlcoin ウォレットを持っていません。Lightning ウォレットへ課金する場合は Groestlcoin ウォレットを新規作成するかインポートする必要があります。続行しますか?',
    list: {
      ...
      tap_here_to_buy: 'Groestlcoin を購入するにはここをタップ',
    },
    reorder: {
      title: 'ウォレットの並び替え',
    },
    ...
    import: {
      title: 'インポート',
      explanation:
        'ここにニモニック、秘密鍵(プライベートキー）、WIFなどを入力してください。Groestlcoin BlueWallet が正しい形式を推測しウォレットをインポートします。',
      imported: 'インポート完了',
  ...
  send: {
    ...
    details: {
      ...
      address: 'アドレス',
      amount_placeholder: '送金額 (GRS)',
      fee_placeholder: '取引手数料 (GRS)',
  ...
  settings: {
    ...
    save: '保存',
    about: 'Groestlcoin BlueWallet について',
    language: '言語',
    currency: '通貨',
  ...
  plausibledeniability: {
    ...
    help:
      ...
      '第三者へ異なるパスワードを提供すれば、Groestlcoin BlueWallet のダミーの' +
