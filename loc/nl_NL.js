module.exports = {
  ...
  wallets: {
    ...
    options: 'opties',
    createBitcoinWallet:
      'Om een Lightning-portemonnee te kunnen gebruiken, is een Groestlcoin-portemonnee nodig om deze te financieren. Wil je toch doorgaan?',
    list: {
      ...
      tap_here_to_buy: 'Klik hier om Groestlcoin te kopen',
    },
    reorder: {
    ...
    import: {
      title: 'importeren',
      explanation:
        'Schrijf hier uw ezelsbruggetje, privésleutel, WIF, of een ander formaat. Groestlcoin BlueWallet zal zijn best doen om het juiste formaat te raden en uw portemonnee te importeren',
      imported: 'Geïmporteerd',
  ...
  send: {
    ...
    details: {
      ...
      address: 'adres',
      amount_placeholder: 'te verzenden bedrag (in GRS)',
      fee_placeholder: 'plus transactie vergoeding (in GRS)',
  ...
  plausibledeniability: {
    ...
    help:
      ...
      'Groestlcoin BlueWallet nog een versleutelde opslag aanmaken, met een ander ' +
      'wachtwoord. Onder druk kunt u dit wachtwoord bekendmaken aan ' +
      'de derde partij. Indien ingevoerd in Groestlcoin BlueWallet, zal het nieuwe ' +
