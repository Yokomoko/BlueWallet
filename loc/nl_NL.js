module.exports = {
  ...
  wallets: {
    ...
    import: {
      title: 'importeren',
      explanation:
        'Schrijf hier uw ezelsbruggetje, privésleutel, WIF, of een ander formaat. GRS BlueWallet zal zijn best doen om het juiste formaat te raden en uw portemonnee te importeren',
      imported: 'Geïmporteerd',
  ...
  plausibledeniability: {
    ...
    help:
      ...
      'GRS BlueWallet nog een versleutelde opslag aanmaken, met een ander ' +
      'wachtwoord. Onder druk kunt u dit wachtwoord bekendmaken aan ' +
      'de derde partij. Indien ingevoerd in GRS BlueWallet, zal het nieuwe ' +
