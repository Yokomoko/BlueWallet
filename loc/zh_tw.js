module.exports = {
  ...
  send: {
    ...
    details: {
      ...
      address: '地址',
      amount_placeholder: '傳送金額(in GRS)',
      fee_placeholder: '手續費用 (in GRS)',
      note_placeholder: '訊息',
      cancel: '取消',
      scan: '掃描',
      send: '傳送',
  ...
  settings: {
    ...
    lightning_settings_explain: '如要要連線你自己的閃電節點請安裝LndHub' + ' 並把url地址輸入到下面. 空白將使用預設的LndHub (lndhub.groestlcoin.org)',
