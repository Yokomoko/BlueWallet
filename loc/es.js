module.exports = {
  ...
  wallets: {
    ...
    import: {
      title: 'importar',
      explanation:
        'Escriba aquí mnemotécnica, clave privada, WIF o cualquier cosa que tenga. GRS BlueWallet hará todo lo posible para adivinar el formato correcto e importar su billetera.',
      imported: 'Importado',
  ...
  plausibledeniability: {
    ...
    help:
      ...
      'contraseña. Para mantener sus monedas seguras, GRS BlueWallet puede crear otro ' +
      ...
      'GRS BlueWallet, desbloqueará un nuevo almacenamiento `falso`. Esto parecerá ' +
