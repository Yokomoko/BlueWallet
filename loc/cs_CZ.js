module.exports = {
  ...
  wallets: {
    ...
    list: {
      ...
      tap_here_to_buy: 'Klikněte zde pro zakoupení Groestlcoinu',
    },
    reorder: {
    ...
    details: {
      ...
      buy_bitcoin: 'Koupit Groestlcoin',
    ...
    import: {
      title: 'importovat',
      explanation:
        'Zadejte zde svůj mnemonic seed, privátní klíč, WIF, nebo cokoliv co máte. Groestlcoin BlueWallet se pokusí uhodnout správný formát a naimportovat vaší peněženku',
  ...
  send: {
    ...
    details: {
      ...
      address: 'adresa',
      amount_placeholder: 'částka k odeslání (v GRS)',
      fee_placeholder: 'plus transakční poplatek (v GRS)',
  ...
  settings: {
    ...
    save: 'save',
    about: 'O Groestlcoin BlueWallet',
    language: 'Jazyk',
    currency: 'Měna',
  ...
  plausibledeniability: {
    ...
    help:
      ...
      'K zajištění bezpečností vašich prostředků, Groestlcoin BlueWallet může vytvořit' +
      'další zašifrované úložiště s rozdílný heslem. V případě potřeby' +
      'můžete toto heslo dát třetí straně. Pokud bude zadáno do Groestlcoin BlueWallet,' +
