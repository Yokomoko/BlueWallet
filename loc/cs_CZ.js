module.exports = {
  ...
  wallets: {
    ...
    import: {
      title: 'importovat',
      explanation:
        'Zadejte zde svůj mnemonic seed, privátní klíč, WIF, nebo cokoliv co máte. GRS BlueWallet se pokusí uhodnout správný formát a naimportovat vaší peněženku',
  ...
  plausibledeniability: {
    ...
    help:
      ...
      'K zajištění bezpečností vašich prostředků, GRS BlueWallet může vytvořit' +
      'další zašifrované úložiště s rozdílný heslem. V případě potřeby' +
      'můžete toto heslo dát třetí straně. Pokud bude zadáno do GRS BlueWallet,' +
