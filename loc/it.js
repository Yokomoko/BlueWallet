module.exports = {
  ...
  wallets: {
    ...
    import: {
      title: 'Importa',
      explanation:
        'Scrivi qui la tua frase mnemonica, chiave privata, WIF, o qualunque altra cosa tu abbia. GRS BlueWallet tenterà di indovinare il formato corretto e importerà il tuo portafoglio',
      imported: 'Importato',
  ...
  plausibledeniability: {
    ...
    help:
      ...
      'password. Per mantenere i tuoi Groestlcoin al sicuro, GRS BlueWallet può creare un altro ' +
      'archivio criptato, con una password diversa. Se costretto, ' +
      'puoi rivelare questa password alle terze parti. Se inserita in ' +
      'GRS BlueWallet, questa sbloccherà un "falso" archivio. Esso sembrerà ' +
