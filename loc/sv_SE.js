module.exports = {
  ...
  wallets: {
    ...
    import: {
      title: 'import',
      explanation:
        'Skriv in dina ord, din privata nyckel, WIF, eller vad du kan tänkas ha. Groestlcoin BlueWallet kommer att göra sitt bästa för att gissa formatet och importera plånboken',
      imported: 'Importerad',
  ...
  plausibledeniability: {
    ...
    help:
      ...
      'lösenord. För att se till att dina pengar är säkra kan Groestlcoin BlueWallet skapa ytterligare en ' +
      'krypterad lagringsyta, med ett annat lösenord. Vid tvång ' +
      'kan du uppge detta alternativa lösenord. När det matas in i ' +
      "Groestlcoin BlueWallet så kommer det att låsa upp din 'fejkade' lagringsyta. Det kommer att se " +
