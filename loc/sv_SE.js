module.exports = {
  ...
  wallets: {
    ...
    import: {
      title: 'import',
      explanation:
        'Skriv in dina ord, din privata nyckel, WIF, eller vad du kan tänkas ha. GRS BlueWallet kommer att göra sitt bästa för att gissa formatet och importera plånboken',
      imported: 'Importerad',
  ...
  send: {
    ...
    details: {
      ...
      address: 'adress',
      amount_placeholder: 'belopp att skicka (i GRS)',
      fee_placeholder: 'plus avgift (i GRS)',
  ...
  settings: {
    ...
    lightning_settings_explain:
      ...
      " och mata in dess URL nedan. Lämna blankt för att använda GRS BlueWallet's LNDHub (lndhub.groestlcoin.org). Plånböcker skapade efter att inställningarna sparats kommer att använda den angivna LNDHub:en",
  ...
  plausibledeniability: {
    ...
    help:
      ...
      'lösenord. För att se till att dina pengar är säkra kan GRS BlueWallet skapa ytterligare en ' +
      'krypterad lagringsyta, med ett annat lösenord. Vid tvång ' +
      'kan du uppge detta alternativa lösenord. När det matas in i ' +
      "GRS BlueWallet så kommer det att låsa upp din 'fejkade' lagringsyta. Det kommer att se " +
