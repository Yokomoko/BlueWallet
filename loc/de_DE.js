module.exports = {
  ...
  wallets: {
    ...
    list: {
      ...
      tap_here_to_buy: 'Klicke hier, um Groestlcoin zu kaufen',
    },
    reorder: {
  ...
  send: {
    ...
    details: {
      ...
      address: 'Adresse',
      amount_placeholder: 'Betrag (in GRS)',
      fee_placeholder: 'plus Gebühr (in GRS)',
  ...
  settings: {
    ...
    lightning_settings_explain:
      ...
      'LndHub\n (lndhub.groestlcoin.org) zu verwenden',
