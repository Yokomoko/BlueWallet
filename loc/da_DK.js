module.exports = {
  ...
  wallets: {
    ...
    list: {
      ...
      tap_here_to_buy: 'Tryk her for at købe Groestlcoin',
    },
    reorder: {
    ...
    import: {
      title: 'importer',
      explanation:
        'Indtast din huskeregel, private nøgle, WIF, eller hvad du end har. Groestlcoin BlueWallet vil forsøge at gætte det rigtige format og importere din wallet',
      imported: 'Importeret',
  ...
  send: {
    ...
    details: {
      ...
      address: 'adresse',
      amount_placeholder: 'beløb der skal sendes (i GRS)',
      fee_placeholder: 'plus transaktionsgebyr (i GRS)',
  ...
  plausibledeniability: {
    ...
    help:
      ...
      'Groestlcoin BlueWallet, vil brugeren se den alternative wallet. Det vil se helt' +
