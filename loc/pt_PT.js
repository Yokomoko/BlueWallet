module.exports = {
  ...
  settings: {
    ...
    lightning_settings_explain:
      ...
      'Deixe em branco para usar o LNDHub da GRS BlueWallet (lndhub.groestlcoin.org). ' +
  ...
  plausibledeniability: {
    ...
    help:
      ...
      'password. Para manter as suas moedas seguras, A GRS BlueWallet pode criar outro ' +
      'armazenamento encriptado, com uma password diferente. Sobre pressão, ' +
      'pode revelar esta password a um terceiro. Se inserida na ' +
      'GRS BlueWallet, esta vai abrir um armazenamento "falso". Que vai parecer ' +
