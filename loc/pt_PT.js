module.exports = {
  ...
  wallets: {
    ...
    createBitcoinWallet: 'Para poder usar uma wallet Lightning, é necessária uma wallet Groestlcoin para a financiar. Deseja continuar?',

    list: {
      app_name: 'Groestlcoin BlueWallet',
      title: 'wallets',
      header: 'Uma wallet representa um par entre um segredo (chave privada) e um endereço' + 'que pode partilhar para receber Groestlcoin.',
      ...
      tap_here_to_buy: 'Toque aqui para comprar Groestlcoin',
    },
    reorder: {
  ...
  send: {
    ...
    details: {
      ...
      amount_placeholder: 'quantia a enviar (em GRS)',
      fee_placeholder: 'mais a taxa de transacção (em GRS)',
  ...
  settings: {
    ...
    lightning_settings_explain:
      ...
      'Deixe em branco para usar o LNDHub da Groestlcoin BlueWallet (lndhub.groestlcoin.org). ' +
  ...
  plausibledeniability: {
    ...
    help:
      ...
      'password. Para manter as suas moedas seguras, A Groestlcoin BlueWallet pode criar outro ' +
      'armazenamento encriptado, com uma password diferente. Sobre pressão, ' +
      'pode revelar esta password a um terceiro. Se inserida na ' +
      'Groestlcoin BlueWallet, esta vai abrir um armazenamento "falso". Que vai parecer ' +
